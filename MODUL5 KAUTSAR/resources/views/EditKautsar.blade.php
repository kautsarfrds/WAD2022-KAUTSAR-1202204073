    ...
    <div class="container">
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav gap-3">
                <a class="nav-link" style="color: #e0e0e0; font-weight: 600;" href="">Home</a>
                ...
                <div class='d-flex justify-content-center align-items-start gap-5 mt-5'>
                  ...
                  <form action='' method='POST' enctype='multipart/form-data'>
                    ...
                    <div>
                      ...
                      <input style='display: block; width: 600px; height: 50px; border: 1px solid #757575; border-radius: 8px; margin-top: 20px; padding-left: 10px; padding-right: 10px;' type='date' id='tanggalbeli' name='tanggalbeli' value=''>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <input type='file' class='form-control' id='inputGroupFile01' value='' name='foto_mobil' style='height: 40px; display: block; width: 600px; border: 1px solid #757575; border-radius: 8px; margin-top: 20px; padding-left: 10px; padding-right: 10px;'>
                    </div>
                    <div>
