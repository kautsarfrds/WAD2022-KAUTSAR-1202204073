                ...
                <div class='d-flex justify-content-center align-items-start gap-5 mt-5'>
                  ...
                  <form action='../config/edit.php?id=" . $detail["id_mobil"] . "' method='POST' enctype='multipart/form-data'>
                    ...
                    <div>
                      ...
                      <input type='file' class='form-control' id='inputGroupFile01' value='" . $detail["foto_mobil"] . "' name='foto_mobil' style='height: 40px; display: block; width: 600px; border: 1px solid #757575; border-radius: 8px; margin-top: 20px; padding-left: 10px; padding-right: 10px;'>
                    </div>
                    <div>
